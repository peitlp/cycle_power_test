...
#define CH2_Input_Pin GPIO_PIN_0
#define CH2_Input_GPIO_Port GPIOG
#define CH1_Input_interrupt_Pin GPIO_PIN_1
#define CH1_Input_interrupt_GPIO_Port GPIOG
#define CH1_Input_interrupt_EXTI_IRQn EXTI1_IRQn
